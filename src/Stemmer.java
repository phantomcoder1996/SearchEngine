...
//    private static final String OUTPUT_FILE="output.txt";
    ...
    public static boolean vowel(String str, int i) {
        if (str.charAt(i) == 'A' || str.charAt(i) == 'E' || str.charAt(i) == 'O' || str.charAt(i) == 'U' || str.charAt(i) == 'I')
            return true;
        else if (i > 0 && str.charAt(i) == 'Y' && (str.charAt(i) == 'A' || str.charAt(i) == 'E' || str.charAt(i) == 'O' || str.charAt(i) == 'U' || str.charAt(i) == 'I'))
            return true;
        return false;
    }
...
// S ->
    ...
    public static String step1C(String str) {
        ...
        if (len > 1 && str.charAt(len - 1) == 'Y' && vowelIn(s1))
    ...
    public static ArrayList<String> stem2(String word) {
        ArrayList<String> words = new ArrayList<String>();
        ArrayList<String> results = new ArrayList<String>();
        String result = "";
        String[] splited = word.split("\\s+");
